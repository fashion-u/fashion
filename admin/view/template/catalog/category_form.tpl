            ...
            <div class="tab-pane active" id="tab-general">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-is_menu<?php echo $language['language_id']; ?>"><?php echo $entry_is_menu; ?></label>
                    <div class="col-sm-10">
                      <?php if (isset($is_menu) AND $is_menu == 1) { ?>
                        <input type="checkbox" name="is_menu" checked="checked" />
                      <?php } else { ?>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-title<?php echo $language['language_id']; ?>"><?php echo $entry_title_h1; ?></label>
                    <div class="col-sm-10">
                      <input type="text" name="category_description[<?php echo $language['language_id']; ?>][title_h1]" value="<?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['title_h1'] : ''; ?>" placeholder="<?php echo $entry_title_h1; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="form-group">
...
<!-- end Поля для склонений -->
         ...
         <div class="tab-pane" id="tab-content-domain">
            ...
            <div class="tab-pane" id="tab-attribute">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-parent"><?php echo $attribute_group['name']; ?></label>
                <div class="col-sm-10">
                  <?php foreach ($attributes as $attribute) { ?>
                    
                    <?php if($attribute['attribute_group_id'] == $attribute_group['attribute_group_id']){ ?>
                      <label class="attr_check" style="margin-right: 10px;width: 200px; float: left;font-weight: normal;">
                        <?php if(isset($selected_attributes[$attribute['attribute_id']])){ ?>
                          <input type="checkbox" name="category_to_attribute[]" value="<?php echo $attribute['attribute_id']; ?>" checked/>&nbsp;&nbsp;-&nbsp;<?php echo $attribute['name']; ?>
                        <?php }else{ ?>
                          <input type="checkbox" name="category_to_attribute[]" value="<?php echo $attribute['attribute_id']; ?>"/>&nbsp;&nbsp;-&nbsp;<?php echo $attribute['name']; ?>
                        <?php } ?>
                      </label>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <?php foreach ($stores as $store) { ?> <?php if (in_array($store['store_id'], $category_store)) { ?>

...
if(strpos($_SERVER['PHP_SELF'], $file[count($file)-1]) !== false){
	...
	*/
	...
	<!-- Меню выбора -->
		...
		<a href="/<?php echo TMP_DIR;?>backend/index.php?route=main_page/main_page.index.php&modul=main_page.baners.php" title="Дополнительные 3 банера"><div class="baners link"></div></a>

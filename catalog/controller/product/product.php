...
class ControllerProductProduct extends Controller {
	...
	public function addLovedProduct() {
		...
		if (isset($this->request->post['product_id'])) {
			echo $this->model_catalog_product->addLovedProduct((int)$this->request->post['product_id']);
		}
			
	}
	
	public function dellLovedProduct() {
		$this->load->model('catalog/product');
		
		if (isset($this->request->post['product_id'])) {
			echo $this->model_catalog_product->dellLovedProduct((int)$this->request->post['product_id']);
		}
...
//=============================================================================================================================		
		...
		if ($product_info) {
			...
			if($product_info['moderation_id'] == 1){
				$product_info['name'] = 'Товар на модерации!';
			}elseif($product_info['moderation_id'] == 2){
				$product_info['name'] = 'Товар забракован!';
			}
			$data['breadcrumbs'][] = array(
				'text' => $product_info['name'],
...
//echo "<pre>";  print_r(var_dump( $data )); echo "</pre>";
			...
			if($product_info['moderation_id'] > 0){
				$data['description'] = '';
				$data['price'] = '0.00';
			}

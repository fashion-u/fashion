...
<!-- /Yandex.Metrika counter -->
  ...
  setTimeout("ga('send','event','Engaged users','More than 15 seconds')",15000);
			...
			<div class="footer-column left">
				<div class="title">Для мобильных устройств</div>
				<a href="#"><img src="/<?php echo TMP_DIR;?>catalog/view/theme/FA/image/icon/attachment-icon1.png" alt="" /></a>
				<a href="#"><img src="/<?php echo TMP_DIR;?>catalog/view/theme/FA/image/icon/attachment-icon2.png" alt="" /></a>
			</div>

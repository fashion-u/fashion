									...
									<div class="column long left">
										...
										<div class="line clearfix">
											...
											<!--div class="inner-column right">
												<span class="__large2"><a href="#">Одежда для спорта</a></span><br>
												<span class="__large2"><a href="#">Одежда для беременных</a></span><br>
												<span class="__large2"><a href="#">Одежда для дома</a></span><br>
												<span class="special __large2"><a href="#">Одежда больших размеров</a></span><br>
												<span class="__large2"><a href="#">Обувь для дома</a></span><br>
												<span class="__large2"><a href="#">Обувь для спорта</a></span><br>
												<span class="__large2"><a href="#">Обувь на шнурках</a></span><br>
												<span class="__large2"><a href="#">Резиновая обувь</a></span><br>
											</div-->
										</div>
									</div>
								</div>
        ...
        <!--/li-->
				...
				<div class="form-office-back"></div>
						  ...
						  <div slass="social_key_wrapper">
							<?php foreach ($adapters as $title => $adapter) { ?>
							  <div class="form_element_social">
								  <a href="<?php echo $adapter->getAuthUrl(); ?>"><?php echo $social_images[ucfirst($title)]; ?></a>
							  </div>
							<?php  } ?>
						  </div>
						</div>
                    ...
                    <form  class="form-registration-drop" id="forgotten" method="post">
						...
						<br /><a href="/index.php?route=account/register">Зарегистрироваться</a-->
      				</form>
                   <?php } ?> 
				...
				<!--private office-->
				    <?php if ($logged) { ?>
                    <div class="form-office-drop footer-column left">
                    <ul style="padding: 15px;text-align: left;">
                        <li><a href="/my_account"><?php echo $text_account; ?></a></li>
						...
						<li>&nbsp;</li>
						<li><div class="yellow-button" id="close-btn">OK</div></li>
                    </ul>
